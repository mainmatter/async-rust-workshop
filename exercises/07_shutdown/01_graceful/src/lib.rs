//! # Exercise
//!
//! `serve` runs until the listener errors, which in practice means until the process is killed. A
//! client mid-request loses its answer, and anything the store had not applied yet is gone.
//!
